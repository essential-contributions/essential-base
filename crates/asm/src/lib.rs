...
//!
//! The [`Constraint`](./op/enum.Constraint.html) type declares all operations
//! that are permitted within constraint execution. Notably, this does not
//! include any control flow or panicking operations.
//!
...
//!
//! The top-level [`Op`](./op/enum.Op.html) type declares all operations that
//! available to state read execution. State read execution is a superset of
//! constraint execution, and includes control flow, memory and state access
//! operations.
