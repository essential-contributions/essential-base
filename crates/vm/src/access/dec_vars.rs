...
#[test_case(
    &[], &[&[3, 99], &[4, 61, 100]] =>
    using assert_err!(OpSyncError::Access(AccessError::MissingArg(MissingAccessArgError::PredDataLen)))
    ; "missing len"
)]
#[test_case(
    &[1], &[&[3, 99], &[4, 61, 100]] =>
    using assert_err!(OpSyncError::Access(AccessError::MissingArg(MissingAccessArgError::PredDataValueIx)))
    ; "missing value_ix"
)]
#[test_case(
    &[0, 1], &[&[3, 99], &[4, 61, 100]] =>
    using assert_err!(OpSyncError::Access(AccessError::MissingArg(MissingAccessArgError::PredDataSlotIx)))
    ; "missing slot_ix"
)]
#[test_case(
    &{
...
#[test_case(
    &[-1, 0, 1], &[&[3]] =>
    using assert_err!(OpSyncError::Access(AccessError::PredicateDataSlotIxOutOfBounds(-1)))
    ; "negative slot_ix"
)]
#[test_case(
    &[1, -1, 1], &[&[3]] =>
...
#[test_case(
    vec![
        ...
        OpSync::from(asm::Access::PredicateData),
    ],
...
#[test_case(
    vec![
        OpSync::from(asm::Stack::Push(1)),
        OpSync::from(asm::Access::PredicateDataLen),
    ],
